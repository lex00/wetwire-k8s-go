...
```
┌─────────────┐
│  Frontend   │ (3 replicas, LoadBalancer)
│   Service   │
└─────┬───────┘
      │
      ▼
┌─────────────┐     ┌──────────────┐     ┌──────────────┐
│  Frontend   │────▶│Redis Follower│────▶│ Redis Leader │
...
- Read [QUICK_START.md](QUICK_START.md) for creating your own project
- See [ADOPTION.md](ADOPTION.md) for migrating existing resources
- Check [DEVELOPERS.md](DEVELOPERS.md) for contributing new examples
