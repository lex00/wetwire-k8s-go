...
Navigate the wetwire-k8s-go documentation by your goal.
...
| Migrate existing YAML | [IMPORT_WORKFLOW.md](IMPORT_WORKFLOW.md) |

## By Audience

### New Users
1. [QUICK_START.md](QUICK_START.md) - Build your first Kubernetes manifest
2. [FAQ.md](FAQ.md) - Common questions and troubleshooting
3. [EXAMPLES.md](EXAMPLES.md) - Real-world manifest patterns

### Regular Users
- [CLI.md](CLI.md) - Complete command reference
- [LINT_RULES.md](LINT_RULES.md) - All WK8 rules with examples
- [TROUBLESHOOTING.md](TROUBLESHOOTING.md) - Common errors and solutions

### Team Adoption
- [ADOPTION.md](ADOPTION.md) - Migration strategies and team onboarding
- [IMPORT_WORKFLOW.md](IMPORT_WORKFLOW.md) - Convert existing YAML manifests
...
- [CODEGEN.md](CODEGEN.md) - Kubernetes type integration
...
| [LINT_RULES.md](LINT_RULES.md) | WK8001-WK8399 rule reference | All users |
| [FAQ.md](FAQ.md) | Common questions and troubleshooting | All users |
| [TROUBLESHOOTING.md](TROUBLESHOOTING.md) | Error solutions | All users |
| [EXAMPLES.md](EXAMPLES.md) | Manifest patterns and examples | Learning users |
| [ADOPTION.md](ADOPTION.md) | Team migration and onboarding | Team leads |
| [IMPORT_WORKFLOW.md](IMPORT_WORKFLOW.md) | Convert existing manifests | Migrating users |
...
| [CODEGEN.md](CODEGEN.md) | Kubernetes type integration | Contributors |
